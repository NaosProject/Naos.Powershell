# this will install Naos-GitBranchingTools.ps1 into your powershell profile

# constants
$ScriptsPath = "C:\Scripts"
$GitBranchingScriptPath = Join-Path $ScriptsPath 'Naos-GitBranchingTools.ps1'
...
Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/NaosFramework/Powershell/master/GIT/Naos-GitBranchingTools.ps1' -OutFile $GitBranchingScriptPath
